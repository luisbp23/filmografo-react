...
function ReviewCard({ titulo, autor, texto, nota }) {
    return (
        <div className="review-card">
            <div className="d-flex justify-content-between align-items-center mb-2">
                <p className="mb-0">
                    <strong>{titulo}</strong> — por <span className="link-autor">{autor}</span>
                </p>
                <button className="icone-denunciar" aria-label="Denunciar crítica">
                    <svg role='img' aria-label='icone de denúncia' viewBox="0 0 24 24" fill="none">
            ...
            <div className="d-flex gap-3 align-items-center">
                <div className="circulo-nota">{nota}</div>
                <p className="texto-critica mb-0">{texto}</p>
            </div>
        </div>
    )
}
