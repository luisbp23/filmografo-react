...
function FilmeDetalhe() {
    ...
    const carregarReviews = useCallback(async () => {
        const dados = await getReviewsByContent(id, 'movie');
        setReviews(dados);
    ...
    const trailer = useMemo(() => {
        if (!filme?.videos?.results) return null;
    ...
    if (erro) {
        return (
            <div className="filme-detalhe-page">
                ...
                <button type="button" className="filme-voltar-btn" onClick={() => navigate(-1)}>
                    ← {t('back')}
                </button>
            </div>
        );
        ...
        <div className="filme-detalhe-page">
            <section className="filme-layout">
                <div className="filme-poster-wrapper">
                    <img src={poster} alt={filme.title} className="filme-poster" />
                </div>
                ...
                <div className="filme-info">
                    ...
                    <h1>{filme.title} {ano && <span>({ano})</span>}</h1>
                    ...
                    <div className="filme-dados">
                        ...
                        <p><strong>{t('budget')}:</strong> {orcamento}</p>
                    </div>
                </div>
            </section>
